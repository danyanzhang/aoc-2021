...
% Goal here should be to segment the code
% there is a hierarchy of code here

packetStart = 1; % this will grow in size as packet gets parsed
i = 1; % packet start
